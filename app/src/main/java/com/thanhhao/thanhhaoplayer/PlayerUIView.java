...
package com.thanhhao.thanhhaoplayer;
...
public class PlayerUIView extends SurfaceView //UniversalMediaController
        implements PlayerUI.MediaPlayerControl,OrientationDetector.OrientationChangeListener{
    private String TAG = "PlayerUIView";
    ...
    private PlayerUI mMediaController;
    ...
    public PlayerUIView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PlayerUIView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.PlayerUIView,0,0);
        mFitXY = a.getBoolean(R.styleable.PlayerUIView_uvv_fitXY, false);
        mAutoRotation = a.getBoolean(R.styleable.PlayerUIView_uvv_autoRotation, false);
        a.recycle();
        initVideoView();
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(PlayerUIView.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            info.setClassName(PlayerUIView.class.getName());
        }
    }
    ...
    public void setMediaController(PlayerUI controller) {
...
//                    }
    ...
    private void enableOrientationDetect() {
        if (mAutoRotation && mOrientationDetector == null) {
            ...
            mOrientationDetector.setOrientationChangeListener(PlayerUIView.this);
