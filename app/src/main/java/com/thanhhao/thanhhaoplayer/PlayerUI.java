...
//    private boolean mFullscreenEnabled = false;
    ...
    public PlayerUI(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.PlayerUI);
        mScalable = a.getBoolean(R.styleable.PlayerUI_uvv_scalable, false);
        a.recycle();
        init(context);
    }
